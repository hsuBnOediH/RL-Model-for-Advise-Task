...
fit_fields = {
    ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','forgetting_rate','with_advise_learning_rate','without_advise_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','forgetting_rate','with_advise_learning_rate','without_advise_win_learning_rate','without_advise_loss_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','forgetting_rate','with_advise_win_learning_rate','with_advise_loss_learning_rate','without_advise_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','with_advise_win_forgetting_rate','with_advise_loss_forgetting_rate','without_advise_win_forgetting_rate','without_advise_loss_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','with_advise_forgetting_rate','without_advise_win_forgetting_rate','without_advise_loss_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','with_advise_win_forgetting_rate','with_advise_loss_forgetting_rate','without_advise_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','large_loss_sensitive','with_advise_win_forgetting_rate','with_advise_loss_forgetting_rate','without_advise_win_forgetting_rate','without_advise_loss_forgetting_rate','learning_rate'}, ...
};
fix_fields ={
    {'left_better','advise_truthness','learning_rate','forgetting_rate','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','learning_rate','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','discount_factor','reaction_time_threshold'}, ...
    {'left_better','advise_truthness','learning_rate','discount_factor','reaction_time_threshold'}, ...
