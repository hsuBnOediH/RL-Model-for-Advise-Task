...
% reward_sensitivity: sensitivity to reward in win trials, fixed to 1 
% loss_sensitivity: sensitivity to loss in lose trials, fixed to 1
...
zero_one_fields = {'left_better','advise_truthness','learning_rate','with_advice_learning_rate','without_advice_learning_rate','with_advice_win_learning_rate','with_advice_loss_learning_rate',...
    ...
    'with_advice_win_forgetting_rate','with_advice_loss_forgetting_rate','without_advice_win_forgetting_rate','without_advice_loss_forgetting_rate'};
% all the parameters need to be transformed into positive values, logit transformation
positive_fields = {'inv_temp','reward_sensitivity','loss_sensitivity','outcome_sensitivity','discount_factor',...
    };

% for 10 candidates, we have 10 different fields settings, all_fields is for free parameters, fixed_fields is for fixed parameters
all_fields = {
    {'inv_temp','outcome_sensitivity'}, ...
    {'inv_temp','outcome_sensitivity','forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','forgetting_rate','learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','forgetting_rate','with_advice_learning_rate','without_advice_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','forgetting_rate','with_advice_learning_rate','without_advice_win_learning_rate','without_advice_loss_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','forgetting_rate','with_advice_win_learning_rate','with_advice_loss_learning_rate','without_advice_learning_rate'}, ...
    {'inv_temp','outcome_sensitivity','with_advice_win_forgetting_rate','with_advice_loss_forgetting_rate','without_advice_win_forgetting_rate','without_advice_loss_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','with_advice_forgetting_rate','without_advice_win_forgetting_rate','without_advice_loss_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','with_advice_win_forgetting_rate','with_advice_loss_forgetting_rate','without_advice_forgetting_rate'}, ...
    {'inv_temp','outcome_sensitivity','with_advice_win_forgetting_rate','with_advice_loss_forgetting_rate','without_advice_win_forgetting_rate','without_advice_loss_forgetting_rate','learning_rate'}, ...
};
fixed_fields ={
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','learning_rate','forgetting_rate','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','learning_rate','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','discount_factor'}, ...
    {'left_better','advise_truthness','reward_sensitivity','loss_sensitivity','learning_rate','discount_factor'}, ...
...
field_params = all_fields{IDX_CANDIDATE}; 
params = struct();
fields = field_params;
