...
qvalue(:, :, 1) = [(params.reward_value/2)*params.p_a-loss*(1-params.p_a),      0,                                                      0;
                   params.reward_value*.5-loss*.5+params.self_reliance_bonus,   (params.reward_value/2)*params.p_a-loss*(1-params.p_a), (params.reward_value/2)*(1-params.p_a)-loss*params.p_a;
                   params.reward_value*.5-loss*.5+params.self_reliance_bonus,   (params.reward_value/2)*(1-params.p_a)-loss*params.p_a, (params.reward_value/2)*params.p_a-loss*(1-params.p_a)];
